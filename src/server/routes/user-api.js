...
/**
 * Open loot box on this endpoint
 *
 ...
 * On changing server state we can not use get as it is Idempotent method
 *
 * One could argue that this end point should have been under players/loot
 * But I feel it is more natural to put it here since each loot is connected to single user
 * and not to whole collection of players
 */
